...
import { Info, FileStack, CrosshairIcon, Loader2 } from 'lucide-react';
  ...
  const handleSubmit = async () => {
    if (intraMode) {
      if (!selectedIntraModel) {
        alert('Sélectionnez un modèle pour la détection intra-modèle');
        return;
      }
      setLoading(true);
      try {
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="flex gap-4 border-b pb-4 mb-4">
            <Button
              variant={intraMode ? "outline" : "default"}
              onClick={() => setIntraMode(false)}
              className="flex-1"
            >
              Entre modèles
            </Button>
            <Button
              variant={intraMode ? "default" : "outline"}
              onClick={() => setIntraMode(true)}
              className="flex-1"
            >
              ...
              <div className="space-y-3">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>
                          Pour la détection intra-modèle, une tolérance plus petite est recommandée 
                          pour détecter les conflits entre éléments proches.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-500">
                    Valeur recommandée: 0.005 - 0.02 m
                  </span>
                </div>
              </div>
            ...
            <div className="grid gap-6 py-4">
              <div className="space-y-2">
                <Label htmlFor="tolerance" className="flex items-center gap-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>
                          Distance minimale entre les éléments pour considérer un clash. 
                          Une valeur plus petite détectera plus de conflits mais prendra plus de temps.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <span className="text-sm text-gray-500">
                    Valeur recommandée: 0.01 - 0.05 m
                  </span>
                </div>
              </div>
                          ...
                          <div className="flex items-start gap-3">
                            <Checkbox
                              ...
                              onCheckedChange={(checked) => 
                                setSelected(prev => ({ ...prev, [model.id]: !!checked }))
                              }
                            />
                            <div>
                              <label 
          ...
          <DialogFooter>
            ...
            <Button 
              ...
              disabled={loading || 
                (intraMode && !selectedIntraModel) || 
                (!intraMode && selectedCount < 2)
              }
